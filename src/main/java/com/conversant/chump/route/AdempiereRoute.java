...
public class AdempiereRoute implements ChumpRoute {
    ...
    public static final ChumpOperation END_CALL_SUBSCRIPTION = build(ENDPOINT_PROVISION, "direct://endCallSubscription");
    ...
    public static final ChumpOperation END_DID_SUBSCRIPTION = build(ENDPOINT_PROVISION, "direct://endDIDSubscription");
    ...
    public static final ChumpOperation CREATE_BUSINESS_PARTNER_BANK_ACCOUNT = build(ENDPOINT_ACCOUNTING, "direct://createBPBankAccount");
    public static final ChumpOperation DELETE_BUSINESS_PARTNER_BANK_ACCOUNT = build(ENDPOINT_ACCOUNTING, "direct://deleteBPBankAccount");
    public static final ChumpOperation CREATE_BUSINESS_PARTNER_PAYMENT = build(ENDPOINT_ACCOUNTING, "direct://createOneOffPayment");
    ...
    public static final ChumpOperation READ_BUSINESS_PARTNER_RADIUS_ACCOUNTS = build(ENDPOINT_PROVISION, "direct://readRadiusAccountsSearch");
    public static final ChumpOperation READ_BUSINESS_PARTNER_USERS = build(ENDPOINT_ADMIN, "direct://readUsersByBusinessPartner");
    public static final ChumpOperation READ_BUSINESS_PARTNER_PAYMENTS = build(ENDPOINT_ACCOUNTING, "direct://readPaymentByBusinessPartner");
    public static final ChumpOperation READ_BUSINESS_PARTNER_ORDERS = build(ENDPOINT_ADMIN, "direct://readOrderByBusinessPartnerSearchKey");
    public static final ChumpOperation READ_BUSINESS_PARTNER_INVOICES = build(ENDPOINT_ACCOUNTING, "direct://readInvoicesByBusinessPartner");
    ...
    public static final ChumpOperation READ_INVOICE = build(ENDPOINT_ACCOUNTING, "direct://readInvoice");
    public static final ChumpOperation READ_INVOICE_LINES = build(ENDPOINT_ACCOUNTING, "direct://readInvoiceLines");
    public static final ChumpOperation READ_INVOICE_TAX_LINES = build(ENDPOINT_ACCOUNTING, "direct://readInvoiceTaxLines");
    ...
    public static final ChumpOperation READ_USER_BY_SEARCH_KEY = build(ENDPOINT_ADMIN, "direct://readUserBySearchKey");
