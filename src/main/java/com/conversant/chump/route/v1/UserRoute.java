...
import static com.conversant.chump.util.Constants.TYPE_CREATE_USER;
import static com.conversant.chump.util.Constants.TYPE_READ_USER;
import static com.conversant.chump.util.Constants.TYPE_UPDATE_USER;
import static com.conversant.chump.util.Constants.TYPE_DELETE_USER;
...
public class UserRoute implements ChumpRoute {
	...
	public static final ChumpOperation READ = ChumpOperation.builder()
			...
			.postProcessors(Arrays.asList(new StandardResponseRemover("user"),ApiResponseProcessor.INSTANCE)).build();
	...
	public static final ChumpOperation DELETE_USER = ChumpOperation
			.builder()
			.trx(false)
			.rest(RestOperation.builder()
					.resource(RESOURCE)
