...
public class Constants {
    ...
    public static final String TYPE_DELETE_BUSINESS_PARTNER_BANK_ACCOUNT = "AC-createBpBankAccount-Intalio";
    ...
    public static final String TYPE_READ_INVOICE_TAX_LINES = "AC-readInvoiceTaxLines-Intalio";
    ...
    public static final String TYPE_READ_USER_BY_SEARCH_KEY = "AD-readUserBySearchKey-Intalio";
